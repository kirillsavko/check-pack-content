 ...
 */
export type AtomicCollection<Data = Record<string, any>> = {
  contract: string
 ...
 */
export type AtomicTemplate<ImmutableData = Record<string, any>> = {
  contract: string
 ...
 */
export type AtomicAsset<ImmutableData = Record<string, any>, MutableData = Record<string, any>> = {
  contract: string
  asset_id: string
  owner: string
  name: string
